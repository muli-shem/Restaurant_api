...
import { getDriversService, getDriverByIdService, createDriverService, updateDriverService, deleteDriverService } from "./driver.service";

// get all drivers
export const getDriversController = async (c: Context) => {
    try {
        const driver = await getDriversService();
